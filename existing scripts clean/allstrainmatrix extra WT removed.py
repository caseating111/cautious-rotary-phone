...
def read_all_strains():
    ...
    for row in strain_rows:
        ...
        canonical = canonical_control_name(
            row["strain"]
        )
    ...
    for control_name, candidates in control_candidates.items():
        ...
        control_rows.append(preferred)


    # WT controls first; all duplicates completely omitted
    strain_rows = control_rows + normal_rows
