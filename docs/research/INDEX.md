...
| --- | --- | --- | --- | --- | --- |
| Python-controlled interactive Fiji / four-point runtime | active / repeated-failure | 3 materially distinct routes | 2026-08-22 | Numeric coercion and Show All removal pass a synthetic real-Fiji QC/CLAHE probe; manual one-plate validation remains. | [fiji-four-point-runtime.md](fiji-four-point-runtime.md) |
