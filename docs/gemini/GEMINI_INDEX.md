...
| Project setup / working-copy rename | READY FOR INTEGRATION | `gemini-project-setup-rename` (`3fd3c55`) | `prepare_working_copy(...) -> RenameResult` | `docs/gemini/prototypes/project_setup_rename/HANDOFF.md` |
