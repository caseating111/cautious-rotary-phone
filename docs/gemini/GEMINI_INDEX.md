...
| Visibility adjustment / review | READY FOR INTEGRATION | `gemini-visibility-adjustment` (`f068a55`) | `adjust_plate_visibility(...) -> AdjustmentResult` | `docs/gemini/prototypes/visibility_adjustment/HANDOFF.md` |
